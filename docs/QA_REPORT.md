...
- 29 release-contract tests pass in the standard suite.
...
| 3 | Five-level progression and post-Satyaki regression | Pass | Passes 69 and 71; packaged `transition_level_01` Electron route |
...
- `Shrugame-1.0.1-windows-x64-Setup.exe`
- `Shrugame-1.0.1-windows-x64-Portable.exe`
