...
- 30 release-contract tests pass in the standard suite.
...
| 3 | Five-level progression, post-Satyaki, and right-edge navigation | Pass | Passes 69, 71, and 72; packaged Electron transition routes |
...
- `Shrugame-1.0.2-windows-x64-Setup.exe`
- `Shrugame-1.0.2-windows-x64-Portable.exe`
